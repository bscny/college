...
private:
  ...
  Card cards_in_hand[kMaxCards];
  string name_of_dealer;
  bool first_card_is_faced_up;
  long rand_seed;
  int first_time_playing;

  int *all_cards;  // will allocate in shuffle function
  int top_of_the_mixed_decks_index;
