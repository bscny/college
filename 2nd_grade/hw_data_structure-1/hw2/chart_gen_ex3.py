...
#graphing
	...
	line_size = 7.5
	font_size = 100
	file_name = "FIG_experiment 3-extra-2.png"
...
#plt.plot(x_data, y_datas[LOMUTO], 'k-o', lw = line_size, ms = dot_size)
	...
	plt.title(f"EXPERIMENT 3  (array size is 2^{VAL_N})", fontsize = font_size)
...
#plt.legend(["Insertion", "Merge", "Lomuto qsort", "Hoare qsort", "3-way qsort", "counting"], fontsize = font_size)
	plt.legend(["Merge", "Hoare qsort", "3-way qsort", "counting"], fontsize = font_size)
